  ...
  return (
    <div className='max-w-screen-2xl mx-auto'>
       ...
       <div className='p-5 flex justify-between items-center'>
        ...
        <Button className='rounded-[20px] border text-lg bg-[#F0F0F0]  hover:bg-black hover:text-white'>Latest</Button>
        <Button className='rounded-[20px] border text-lg bg-[#F0F0F0]  hover:bg-black hover:text-white'>Write a Review</Button>
        </div>
       </div>
       {/* container */}
       <div className='grid grid-cols-1 md:grid-cols-2 p-4 gap-6'>
        {
            reviews.map((data)=>{
                return(
                    <div className='border rounded-[20px] p-8 space-y-4'>

...
export default function Hero() { 
  ...
  return (
    <div className=' w-full h-full md:h-[500px] flex flex-col md:flex-row justify-center items-start  bg-[#F2F0F1]'>
        {/* rightside text*/}
        <div className='  w-full md:w-[600px] h-full md:h-[85%] mt-3 md:mt-10 pl-3 relative '>
        ...
        <Image  src={"/images/bg-half.png"} width={500} height={200} alt="pic" className="w-[555px] mr-4"></Image>
        ...
        <Image src="/images/Vector.png" alt="image" width={100} height={100} className='md:w-[56px] md:h-[56px] w-[40px] h-[40px] absolute md:right-[650px] md:top-[250px]
